...
COPY --chown=avalon:avalon server.py game_logic.py chat_store.py selfie_archive.py chat_history.py game_history.py selfie_history.py analytics_history.py research_telemetry.py research_history.py ./
